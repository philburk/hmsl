...
exists? ob.amiga.instrument .IF
    OB.AMIGA.INSTRUMENT INS-AMIGA-1
    OB.AMIGA.INSTRUMENT INS-AMIGA-2
    OB.AMIGA.INSTRUMENT INS-AMIGA-3
    OB.AMIGA.INSTRUMENT INS-AMIGA-4
.THEN
